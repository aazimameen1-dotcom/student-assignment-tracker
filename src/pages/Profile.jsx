...
export default function Profile() {
  ...
  return (
    <div className="animate-fade-in max-w-6xl mx-auto px-4 md:px-8 py-8 space-y-6 text-left pb-24 select-none">
      ...
      <div className="flex items-center justify-between bg-[#231f5c] text-white p-4 rounded-2xl shadow-sm">
        <h2 className="font-headline text-xl font-bold">
          {isEditing ? 'Edit Profile' : 'Your Profile'}
        </h2>
        <button 
          onClick={() => setIsEditing(!isEditing)}
          className="bg-white text-[#231f5c] px-4 py-1.5 rounded-xl font-bold text-xs hover:bg-purple-50 transition-all flex items-center gap-1.5 cursor-pointer shadow-sm"
        >
      ...
      {/* Main Profile Grid matching PDF Pages 3 & 4 */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        
        {/* Left Sidebar Card (PDF Page 3 & 4) */}
        <div className="col-span-1 md:col-span-4 bg-[#231f5c] text-white rounded-3xl p-6 shadow-md space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
          
          {/* Profile Picture */}
          <div className="relative group my-2">
            <div className="w-40 h-40 rounded-full border-4 border-purple-400/30 overflow-hidden bg-purple-900 shadow-xl flex items-center justify-center">
              <img 
          ...
          <div className="w-full text-center md:text-left">
            ...
            <p className="text-xs text-purple-200 opacity-80 mt-0.5 font-mono">{studentId}</p>
          </div>

          {/* About Section */}
          <div className="w-full assignify-card-purple text-slate-800 p-5 rounded-2xl border-none space-y-2 text-xs leading-relaxed">
            ...
            {isEditing ? (
              <textarea 
                ...
                rows={5}
                className="w-full p-2 bg-white rounded-xl border border-purple-200 text-xs focus:outline-none focus:ring-2 focus:ring-purple-600 text-slate-800"
              />
            ) : (
          ...
          <div className="w-full space-y-2 pt-2">
            ...
            >
              ...
              <span>{isEditing ? 'Preview Profile' : 'Edit Profile'}</span>
            </button>
            <button 
        ...
        {/* Right Content Area Cards (PDF Pages 3 & 4) */}
        <div className="col-span-1 md:col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="bg-white p-3.5 rounded-xl border border-indigo-100 flex justify-between items-center">
                <div>
                  ...
                  {isEditing ? (
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="font-bold text-slate-900 border-b border-purple-400 focus:outline-none" />
                  ) : (
              ...
              <div className="bg-white p-3.5 rounded-xl border border-indigo-100 flex justify-between items-center">
                <div>
                  ...
                  {isEditing ? (
                    <input type="text" value={studentId} onChange={(e) => setStudentId(e.target.value)} className="font-bold text-slate-900 border-b border-purple-400 focus:outline-none" />
                  ) : (
          ...
          <div className="assignify-card-lavender p-6 rounded-2xl space-y-4 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="bg-white p-3.5 rounded-xl border border-indigo-100 flex justify-between items-center col-span-1 md:col-span-2">
                <div>
                  <span className="text-slate-400 font-semibold block text-[10px] uppercase">Institution</span>
                  {isEditing ? (
                    <input type="text" value={institution} onChange={(e) => setInstitution(e.target.value)} className="font-bold text-slate-900 border-b border-purple-400 focus:outline-none w-full" />
                  ) : (
              ...
              <div className="bg-white p-3.5 rounded-xl border border-indigo-100 flex justify-between items-center">
                <div>
                  ...
                  {isEditing ? (
                    <input type="text" value={semester} onChange={(e) => setSemester(e.target.value)} className="font-bold text-slate-900 border-b border-purple-400 focus:outline-none" />
                  ) : (
              ...
              <div className="bg-white p-3.5 rounded-xl border border-indigo-100 flex justify-between items-center">
                <div>
                  ...
                  {isEditing ? (
                    <input type="text" value={program} onChange={(e) => setProgram(e.target.value)} className="font-bold text-slate-900 border-b border-purple-400 focus:outline-none" />
                  ) : (
              ...
              <div className="bg-white p-3.5 rounded-xl border border-indigo-100 flex justify-between items-center col-span-1 md:col-span-2">
                <div>
                  ...
                  {isEditing ? (
                    <input type="text" value={yearOfStudy} onChange={(e) => setYearOfStudy(e.target.value)} className="font-bold text-slate-900 border-b border-purple-400 focus:outline-none" />
                  ) : (
